...
<ul>
  <li>
    <div style={{ display: 'flex', alignItems: 'center' }}>
      ...
      <a href="https://www.figma.com/design/3j5Nb0oOSkF3DW3URS8yex/mParticle-Icons-1.0.0?node-id=2055-9952&t=K7xlZo0hE2tn2y54-0" target="_top" rel="nofollow" className="sbdocs sbdocs-a">Figma Icon Library</a>
    </div>
  </li>
 <li>
    <div style={{ display: 'flex', alignItems: 'center' }}>
 ...
 <li>
    <div style={{ display: 'flex', alignItems: 'center' }}>
      <img src="https://badgen.net/badge/icon/Figma?icon=libraries&label&color=purple" alt="Repo" style={{ marginRight: 8 }}/>
      <a href="https://fontawesome.com/search?o=r&s=ligh" target="_top" rel="nofollow" className="sbdocs sbdocs-a">Font Awesome Library</a>
    </div>
  </li>
</ul>
