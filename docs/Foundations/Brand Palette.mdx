...
### Primary
The Primary Color is the main brand color, used to represent key actions and elements across the UI. In mParticle UI, this color is typically applied to interactive elements such as primary buttons, active links, and highlighted items to draw user attention and establish brand identity.
